...
bed = normrnd(5,1,210000,1);
sleep = normrnd(6,1,210000,1);
lighton = normrnd(3,1,210000,1);
lightoff = normrnd(3.5,1,210000,1);
figure
...
ylabel('features values',FontSize=16)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%kitchen 
kettle = normrnd(7,1,19999,1);
microwave = normrnd(9,1,19999,1);
water_purifier = normrnd(5,1,19999,1);
induction = normrnd(3.5,1,19999,1);
Fridge = normrnd(5.5,1,19999,1);
figure
...
gardning = normrnd(7,1,15000,1);
silent_dog = normrnd(9,1,15000,1);
figure
...
TV = normrnd(7,1,17000,1);
reading = normrnd(10,1,17000,1);
newspaper = normrnd(6,1,17000,1);
exercise = normrnd(4.5,1,17000,1);
entertainment = normrnd(5.5,1,17000,1);
stairs = normrnd(4.5,1,17000,1);
entry = normrnd(5.5,1,17000,1);
figure
